...
class Drone(models.Model):
    ...
    status_battery = models.CharField(max_length=255, default="charging")
    status_fly = models.CharField(max_length=255, default="waiting")
    status_order = models.CharField(max_length=255, default="waiting")
