    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_battery', models.CharField(default='charging', max_length=255)),
                ('status_fly', models.CharField(default='waiting', max_length=255)),
                ('status_order', models.CharField(default='waiting', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_history', to='demo.order')),
            ],
        ),
        migrations.CreateModel(
            name='DoorStatus',
